...
import { Box, Button, Container, Flex, Heading, Input, Text, Spinner, Checkbox } from '@chakra-ui/react';
...
export default function NewBookPage() {
  ...
  if (catsLoading) return <Flex justify="center" p={10}><Spinner /></Flex>;
  ...
  return (
    <Container maxW="container.md" py={8}>
      ...
      <Box bg="white" p={8} borderRadius="xl" boxShadow="sm">
        <Heading size="lg" mb={6}>Add New Book</Heading>
        ...
        <form onSubmit={handleSubmit}>
          <Flex direction="column" gap={5}>
            ...
            <Button type="submit" colorScheme="blue" size="lg" mt={4} disabled={loading}>
              {loading ? <Spinner size="sm" /> : 'Create Book'}
            </Button>
          </Flex>
        </form>
      </Box>
